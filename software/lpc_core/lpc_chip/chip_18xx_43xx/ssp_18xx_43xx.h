...
typedef struct SSP_ConfigFormat {
	...
	CHIP_SSP_CLOCK_FORMAT_T clockFormat;/**< Format config: clock phase/polarity */
 ...
 * @return	Nothing
 */
void Chip_SSP_Set_Master(LPC_SSP_T *pSSP, bool master);
 ...
 * @return	Nothing
 */
void Chip_SSP_Set_BitRate(LPC_SSP_T *pSSP, uint32_t bit_rate);
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_SSP_Set_Format(LPC_SSP_T *pSSP, SSP_ConfigFormat *format)
{
